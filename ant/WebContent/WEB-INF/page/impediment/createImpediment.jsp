...
<body>
	...
	<s:form name="createImpediment" action="saveimpediment" method="POST" theme="simple">
	<s:hidden name="impediment.project.id" value="%{projectId}"/>
	<s:hidden name="impediment.status" value="0"/>
	<p class="title">新增障碍</p>
